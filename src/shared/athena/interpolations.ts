...
namespace interpolate {
    export function interpolate(t: number, n0: number, n1: number, style: keyof typeof interpolations) {
        let begin = n0;
        let _end = n1;
    ...
    export function interpolateV3(t: number, v0: Vector3, v1: Vector3, style: keyof typeof interpolations) {
    ...
    export function interpolateV2(t: number, v0: Vector2, v1: Vector2, style: keyof typeof interpolations) {
        let x = interpolate(t, v0.X, v1.X, style);
        let y = interpolate(t, v0.Y, v1.Y, style);
