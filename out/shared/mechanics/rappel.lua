...
local _mathf = TS.import(script, game:GetService("ReplicatedStorage"), "TS", "modules", "mathf")
local mathf = _mathf
local closestPointOnPart = _mathf.closestPointOnPart
local peripherals = TS.import(script, game:GetService("ReplicatedStorage"), "TS", "modules", "utils").peripherals
